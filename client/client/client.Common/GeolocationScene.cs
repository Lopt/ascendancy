...
namespace client.Common
{
    ...
    public class GeolocationLayer: CCLayerColor
    {
            ...
            : base()
        {
            ...
            LabelLastLatitude = new CCLabelTtf(LastLatitude, "arial", 22);
            LabelLastLongitude = new CCLabelTtf(LastLongitude, "arial", 22);
            LabelLastTimestamp = new CCLabelTtf(LastTimestamp, "arial", 22);
            LabelLastAltitude = new CCLabelTtf(LastAltitude, "arial", 22);
