namespace Client.Common.Views.HUD
{
    ...
    /// <summary>
    /// Population resource display. Shows the node the resource "population".
    /// </summary>
    public class PopulationResource : HUDNode
    {
        /// <summary>
        ...
        {
            var population = GameAppDelegate.Account.Population;
        }
        ...
        {
            var population = GameAppDelegate.Account.Population;
            m_progress.Percentage = (float)population.ValuePercent * 100;
        }
